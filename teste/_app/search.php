...
define('APP_URL', 'http://localhost/eventstudy/teste/_app/search.php/');
...
if (isset($accessToken)) {
	...
	$search = $fb->get('/search?q=programacao&type=event');
	$search = $search->getGraphEdge()->asArray();

  echo '<hr>';
	foreach ($search as $key) {
		echo '<strong>Nome do evento :</strong>  '.$key['name'] . '<br>'
    .'<strong>Lugar do evento :</strong> ' .$key['place']['name'].'<br>'
    .'<strong>Lugar do evento :</strong> ' .$key['place']['location'] ['city'].'<br>'
    .'<strong>Lugar do evento :</strong> ' .$key['place']['location'] ['street'].'<br>'
    .'<strong>Lugar do evento :</strong> ' .$key['place']['location'] ['zip'].'<br>'
     .'<strong>Descrição do evento :</strong> '. $key['description']. '<br>'.'<br>'.'<hr>';
	}
